...
public class SingleplayerChessView extends View implements ModelListener{
    Paint paint;
    Model model;
    ...
    public SingleplayerChessView(Context context) {
        super(context);
        paint = new Paint();
     ...
     * @param newSingleplayerController the new multiplayerController
     */
    public void setSingleplayerController(SingleplayerController newSingleplayerController) {
        singleplayerController = newSingleplayerController;
    }
